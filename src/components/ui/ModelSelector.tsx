...
const ModelSelector: React.FC<ModelSelectorProps> = ({ onModelChange, onChatOpen }) => {
  ...
  if (isLoading) {
    return (
      <div className="p-4 bg-black/95 backdrop-blur-md rounded-lg border border-white/15">
  ...
  return (
    <div className="p-4 bg-black/95 backdrop-blur-md rounded-lg border border-white/15 space-y-4">
      ...
      {/* Current Status */}
      {currentConfig && (
        <div className="text-xs text-gray-300 bg-black/80 p-2 rounded border border-white/10">
          ...
          <button
            ...
            className={`flex-1 px-3 py-2 rounded text-xs transition-all ${
              selectedProvider === 'gemini'
                ...
                : 'bg-black/80 text-gray-300 hover:bg-black/90 border border-white/20'
            }`}
          >
            ☁️ Gemini (Cloud)
          </button>
      ...
      {selectedProvider === 'gemini' ? (
        <div className="space-y-2">
          ...
          <input
            ...
            className="w-full px-3 py-2 text-xs bg-black/80 border border-white/20 rounded focus:outline-none focus:ring-2 focus:ring-blue-400/60 text-gray-200 placeholder-gray-500"
          />
        </div>
      ) : (
        <div className="space-y-2">
          <div>
            ...
            <input
              ...
              className="w-full px-3 py-2 text-xs bg-black/80 border border-white/20 rounded focus:outline-none focus:ring-2 focus:ring-green-400/60 text-gray-200 placeholder-gray-500"
            />
          </div>
          ...
          <div>
            <div className="flex items-center gap-2">
              ...
              <button
                ...
                className="px-2 py-1 text-xs bg-black/80 hover:bg-black/90 rounded transition-all border border-white/20 text-gray-300"
            ...
            {availableOllamaModels.length > 0 ? (
              <select
                ...
                className="w-full px-3 py-2 text-xs bg-black/80 border border-white/20 rounded focus:outline-none focus:ring-2 focus:ring-green-400/60 text-gray-200"
              >
              ...
              <div className="text-xs text-gray-300 bg-yellow-900/80 p-2 rounded border border-yellow-700/40">
